...
enum Register
{
  COMMAND_SPEED = 0b00000000,
  COMMAND_CONFIG = 0b00000010,
  COMMAND_GPIO_DEFINE = 0b00000100,
  COMMAND_DAC = 0b00000110,
  COMMAND_ALARM_ENABLE = 0b00001000,
  COMMAND_ALARM_STATUS = 0b00001010,
  COMMAND_TACH_0 = 0b00001100,
  COMMAND_TACH_1 = 0b00001110,
  COMMAND_TACH_2 = 0b00010000,
  COMMAND_TACH_3 = 0b00010010,
  COMMAND_GPIO_STATUS = 0b00010100,
  COMMAND_TACH_COUNT_TIME = 0b00010110
};
...
enum ConfigMask
{
  MODE_MASK = 0b00110000,
  VOLTAGE_MASK = 0b00001000,
  PRESCALER_MASK = 0b00000111
};

enum ConfigMode
{
  MODE_FULL_ON = 0b00000000,
  MODE_FULL_OFF = 0b00010000,
  MODE_CLOSED_LOOP = 0b00100000,
  MODE_OPEN_LOOP = 0b00110000
};

enum ConfigFanVoltage
{
  VOLTAGE_12 = 0b00001000,
  VOLTAGE_5 = 0b00000000
};

extern const ConfigFanVoltage DEFAULT_FAN_VOLTAGE;

enum ConfigPrescaler
{                            // 76543210
